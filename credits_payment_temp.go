...
const CreditsPaymentTemplate = `<div style="font-family:Helvetica Light,Helvetica,Arial,sans-serif;margin:0;padding:0; width:100%" bgcolor="#eeeeee">  
...
Your payments of <b>${{amount}}</b> for <b>{{total_credits}} credits</b> for Calls/SMS was received on <b>{{date_received}}.</b>
</p>
...
<tr>
<td style="border-bottom:1px solid #e4e6e9;color:#7a828c;padding:10px 3px;text-align:left;vertical-align:top;width:33%">Total Credits:</td>
