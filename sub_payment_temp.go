...
const SubPaymentTemplate = `<div style="font-family:Helvetica Light,Helvetica,Arial,sans-serif;margin:0;padding:0; width:100%" bgcolor="#eeeeee">  
...
Your payments of <b>${{amount}}</b> for <b>Professional plan</b> {{capa_txt}} was received on <b>{{date_received}}.</b>
Your plan starts <b>immediately</b> and will run till <b>{{plan_ends}}</b>
</p>
...
<tr>
<td style="border-bottom:1px solid #e4e6e9;color:#7a828c;padding:10px 3px;text-align:left;vertical-align:top;width:33%">Plan Type:</td>
...
<tr>
<td style="border-bottom:1px solid #e4e6e9;color:#7a828c;padding:10px 3px;text-align:left;vertical-align:top;width:33%">Additional Capacity:</td>
<td style="border-bottom:1px solid #e4e6e9;color:#7a828c;padding:10px 3px;text-align:left;vertical-align:top;width:33%">
<b>{{additional_capacity}}</b>
</td>
</tr>
...
<tr>
<td style="border-bottom:1px solid #e4e6e9;color:#7a828c;padding:10px 3px;text-align:left;vertical-align:top;width:33%">Ends On:</td>
<td style="border-bottom:1px solid #e4e6e9;color:#7a828c;padding:10px 3px;text-align:left;vertical-align:top;width:33%">
<b>{{plan_ends}} (30 days)</b>
</td>
</tr>
