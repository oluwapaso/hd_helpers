...
const AddNewAgentTemplate = `<div style="font-family:Helvetica Light,Helvetica,Arial,sans-serif;margin:0;padding:0; width:100%" bgcolor="#eeeeee">  
    ...
    <tr>
    <td align="center" style="color:#000000;font-family:Arial,Helvetica,sans-serif;font-size:15px;font-weight:normal;line-height:22px;padding:30px 5% 0px; text-align: left;" >
    Hello {{fullname}}<br/>
    A new {{app_name}} account was created for you by admin at <b>{{company_name}}</b>. We\'re so excited to have you onboard, contact <b>{{company_name}}\'s</b> admin for your login info. 
    </td>
    </tr>
